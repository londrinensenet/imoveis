...
PRIVATE_FIELDS={"id","cliente_id","nome","tipo","creci","status","ativo","razao_social","cpf_cnpj","responsavel","email_login","email_administrativo","telefone_administrativo","celular_administrativo","whatsapp_administrativo","cep","uf","cidade","bairro","logradouro","numero","complemento","referencia","observacoes","nome_publico","telefone_publico","whatsapp","email_publico","site","imagem_tipo","imagem_url","descricao_publica","regioes"}
